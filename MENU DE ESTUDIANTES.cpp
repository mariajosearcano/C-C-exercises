...
int main ()
{
	...
	while (Res_ME != '6')
	{
		cout << endl << endl << endl << "\t" << "MENU DE ESTUDIANTES" << endl << endl;
		...
		switch (Res_ME)
		{
			...
			case '2':	cout << endl << endl << "\t" << "Menú de impresión" << endl << endl;
			...
			case '3':	BORRAR (Num_U, Ced_U, Nom_U, Edad_U, Ced_E);
						
						break;
						
			case '4':	cout << endl << endl << "\t" << "Menú de inserción" << endl << endl;
			...
			case '5':	cout << endl << endl << "\t" << "Menú de busqueda" << endl << endl;
						...
						else
						{
							...
							cout << endl << "\t" << "¿Qué dato del usuario desea modificar?" << endl << endl;
							cout << "1. Cédula" << endl;
							cout << "2. Nombre" << endl;
							cout << "3. Edad" << endl;
...
void BORRAR (short &NmU, int CU[], string NU[], short EU[], int &CE)
{
	...
	cout << "Ingrese la cédula del usuario del cuál desee eliminar sus datos: ";
	cin >> CE;
	fflush (stdin);
	cout << endl;
